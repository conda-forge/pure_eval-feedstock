...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pure_eval-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8752&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pure_eval-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pure_eval` can be installed with:

```
conda install pure_eval
```

It is possible to list all of the versions of `pure_eval` available on your platform with:
